...
def login_to_portal(campus: str, student_id: str,
                    password: str) -> Union[str, Tuple[str, Browser]]:
  """
...
def get_profile(campus: str, student_id: str,
                password: str) -> Union[str, Tuple[str, str]]:
  """
  ...
  if isinstance(login_response, tuple):
    ...
    return (image, 'Full Name : ' + user_name + '\n' + 'ID No. : ' + user_id +
            '\n' + 'Department : ' + department + '\n' + "Year : " + year)
  else:
    return login_response


def get_grades(campus: str, student_id: str,
               password: str) -> Union[str, List[str]]:
  """
